...
public class Converters {
    ...
    public static Card createCard(final ReadableMap cardData) {
        CardBrand brand = new CardBrandHelper().getCardBrandFromCode(getValue(cardData, "brand"));
    ...
    private static CardBrand createCardBrand(final String code) {
        return CardBrand.valueOf(code);
    }
...
//    }
    ...
    public static BankAccount createBankAccount(ReadableMap accountData) {
        BankAccount account = new BankAccount(
                getStringOrNull(accountData, "accountHolderName"),
                getStringOrNull(accountData, "accountHolderType"),
                null,
